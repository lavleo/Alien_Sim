...
This model implements basic tracking for the predators. Every tick of the simulation includes advancing each entity
to its target waypoint. For Prey this waypoint is randomly generated (and regenerated upon arrival), and for the
Predator this waypoint is always the closest Prey.
                                    
When within a specific range of the Predator the Prey will attempt to circumvent it by moving sideways and around
the predator (usually to no avail!). Predators move at 5 units/second, and Prey at 4.5 units/second.
                                    
The model ticks at a rate of 4Hz, or in other words, updates simulation with 0.25s steps.
''')
